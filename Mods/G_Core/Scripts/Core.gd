...
var gcubiixcompiler = preload("res://Mods/G_CubiixCore/Scripts/CubiixCompiler.gd").new()
...
func _ready() -> void:
	...
	#var newmeshdict:Dictionary = gmeshcompiler.compile_mesh($Core/Characters/Cubiix/Model/Armature/Skeleton3D/Body.mesh,earmesh.get_node("Armature/Skeleton3D/Ears_1").mesh, false)
	#var oldmat = $Core/Characters/Cubiix/Model/Armature/Skeleton3D/Body.mesh.surface_get_material(0)
	...
	#
	#
	#$Core/Characters/Cubiix/Model/Armature/Skeleton3D/Body.mesh = newmeshdict["mesh"]
	#$Core/Characters/Cubiix/Model/Armature/Skeleton3D/Body.set_blend_shape_value(0,1.0)
