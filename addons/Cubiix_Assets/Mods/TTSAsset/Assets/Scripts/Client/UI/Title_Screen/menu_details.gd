...
func setup() -> void:
	...
	for i in FactionBox.get_children():
		i.get_node("TextureRect").texture = ("res://addons/Cubiix_Assets/Mods/TTSAsset/Assets/Textures/UI/Faction_Icons/"+i.name+"_Logo_V2.png")
	var faction = PositionFaction[parent.Faction]
	FactionBox.get_node(faction).get_node("TextureRect").texture = ("res://addons/Cubiix_Assets/Mods/TTSAsset/Assets/Textures/UI/Faction_Icons/"+faction+"_Logo_V2_Glow.png")
...
func _on_faction_pressed(extra_arg_0: String) -> void:
	for i in FactionBox.get_children():
		i.get_node("TextureRect").texture = ("res://addons/Cubiix_Assets/Mods/TTSAsset/Assets/Textures/UI/Faction_Icons/"+i.name+"_Logo_V2.png")
	FactionBox.get_node(extra_arg_0).get_node("TextureRect").texture = ("res://addons/Cubiix_Assets/Mods/TTSAsset/Assets/Textures/UI/Faction_Icons/"+extra_arg_0+"_Logo_V2_Glow.png")
