...
var TimeArray = [Color("#FFFFFF"),1.0, 1.0,Color("#059dff")]
func _ready() -> void:
...
func _process(delta: float) -> void:
	...
	if time_of_day >= -180 && time_of_day <= 0:
		TimeArray = [Color("#FFFFFF"),1.0, 1.0,Color("#059dff")]
	...
	#	$"../WorldEnvironment".environment.ambient_light_color = lerp($"../WorldEnvironment".environment.ambient_light_color,Color("#6e9fd9"), 0.05)
		...
		TimeArray = [Color("#00135a"),0.0, 0.8,Color("#2f0061")]
	...
	$DirectionalLight3D.light_color = lerp($DirectionalLight3D.light_color,TimeArray[0], 0.002)
	$"../WorldEnvironment".environment.fog_light_color = lerp($"../WorldEnvironment".environment.fog_light_color,TimeArray[3], 0.002)
